...
location = '~/Documents/Shmoo_Lab/Flexostat-interface/Data/10-20-17/test_data_'
...
for chamber in range(1,9):
	...
	plt.savefig('Data/10-20-17/od/ch{}_scatter.png'.format(chamber))
...
for chamber in range(1,9):
	...
	plt.savefig('Data/10-20-17/growth/ch{}_growth_rate.png'.format(chamber))
